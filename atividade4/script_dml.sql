...
/*Query 1: todos os livros da autora J.K. Rowling*/
SELECT l.* FROM livro l JOIN autor a ON l.id_autor = a.id_autor WHERE a.nome = 'J.K. Rowling';

/*Query 2: todos os livros da categoria Filosofia*/
SELECT l.* FROM livro l JOIN categoria c ON l.id_categoria = c.id_categoria WHERE c.nome = 'Filosofia';

/*Query 3: altera o nome da categoria Filosofia para Censurado*/
UPDATE categoria SET nome = 'Censurado' WHERE nome = 'Filosofia';

/*Query 4: deleta todos os livros da categoria Censurado*/
DELETE l FROM livro l JOIN categoria c ON l.id_categoria = c.id_categoria WHERE c.nome = 'Censurado';
